...
from recklock.constants import DEFAULT_INCIDENTS_PATH as _DEFAULT_INCIDENTS_STR
from recklock.constants import DEFAULT_TRUST_PROFILES_PATH as _DEFAULT_PROFILES_STR
