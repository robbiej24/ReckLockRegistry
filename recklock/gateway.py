...
from recklock.connectors.base import ConnectorRequest as ConnectorInvocationRequest
from recklock.connectors.base import ConnectorResponse as ConnectorCallResult
from recklock.connectors.base import sanitize_for_audit
from recklock.connectors.registry import get_connector
from recklock.manifest import load_manifest
from recklock.policy import ActionRequest, Policy, PolicyDecision, collect_matching_rules, evaluate_action
...
def execute_request(
    ...
    *,
    ...
    5. Run :func:`recklock.policy.evaluate_action`.
    ...
    Append the returned ``audit_event`` with :func:`recklock.audit.append_event` to persist.
    ...
    *approval_log_path* (default ``approval_logs/approvals.jsonl``) unless *db_session*
    ...
    if policy_decision.decision == "require_approval":
        ...
        if db_session is not None:
            ...
            repos = importlib.import_module("recklock.db.repositories")
