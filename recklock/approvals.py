...
from recklock.constants import DEFAULT_APPROVAL_LOG_PATH as _DEFAULT_APPROVAL_LOG_STR
from recklock.policy import Rule
...
class ApprovalCreationDocument(BaseModel):
    """YAML input for :func:`create_approval_request` via the CLI (`recklock-registry create-approval`)."""
