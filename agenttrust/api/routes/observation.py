...
from agenttrust.api.deps import get_paths, get_settings
from agenttrust.api.settings import ApiSettings, ResolvedPaths
from agenttrust.auth.dependencies import require_permission
from agenttrust.auth.service import PERM_OBSERVATION_APPEND, PERM_OBSERVATION_READ
from agenttrust.discovery.evidence import build_evidence_report
...
def get_discovery_candidates(
    ...
    if not path.is_file():
        return {"candidates": [], "note": "Run ``agenttrust discover-agents`` to populate evidence/discovered_agents.json."}
    try:
